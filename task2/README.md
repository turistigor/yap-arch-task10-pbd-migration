...
Аналитический слой - ETL в виде оркестратора задач (Airflow) и аналитической БД (ClickHouse):
  ...
  - с помощью инструментов вроде OpenLineage, интегрированных в Airflow, можно четко отследить весь путь данных (Lineage).

Employee UI и Medicine осознанно не разделены на более мелкие сервисы, чтобы уменьшить сложность взаимодействия компонентов в системе на ранних этапах разработки. По мере развития системы их, скорее всего, нужно будет разделить на более мелкие части.
